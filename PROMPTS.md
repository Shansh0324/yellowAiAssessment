...
## System Prompt (used in ai/prompts/system.md)
...
## Tool Definitions
Tools are provided to the LLM via OpenAI's JSON Schema format. The prompt explicitly informs the LLM to rely ONLY on these tools for fetching external facts (Order data, Policies).
